...
from src.models.segment_anything.modeling import MaskDecoder, PromptEncoder, TwoWayTransformer
from src.models.segment_anything.modeling.mask_decoder import MaskDecoder
from src.models.segment_anything.modeling.prompt_encoder import PromptEncoder
from src.models.segment_anything.utils.amg import build_all_layer_point_grids
from src.models.segment_anything.utils.transforms import ResizeLongestSide
from torchvision.transforms.functional import resize, to_pil_image

from src.models.efficientvit.models.efficientvit.backbone import EfficientViTBackbone, EfficientViTLargeBackbone
from src.models.efficientvit.models.nn import (
    ConvLayer,
    DAGBlock,
    FusedMBConv,
    IdentityLayer,
...
from src.models.efficientvit.models.utils import build_kwargs_from_config, get_device
...
def build_efficientvit_sam(image_encoder: EfficientViTSamImageEncoder, image_size: int) -> EfficientViTSam:
    return EfficientViTSam(
        ...
        prompt_encoder=PromptEncoder(
            ...
            input_image_size=(image_size, image_size),  # Modified from (1024, 1024)
            mask_in_chans=16,
        ),
        mask_decoder=MaskDecoder(
        ...
        image_size=(image_size, image_size),  # Modified from (1024, image_size)
    )


def efficientvit_sam_l0(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from src.models.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l0
...
def efficientvit_sam_l1(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from src.models.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l1
...
def efficientvit_sam_l2(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from src.models.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l2
...
def efficientvit_sam_xl0(image_size: int = 1024, **kwargs) -> EfficientViTSam:
    from src.models.efficientvit.models.efficientvit.backbone import EfficientViTLargeBackbone
